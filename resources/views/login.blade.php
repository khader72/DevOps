                                ...
                                <div class="p-5">
                                    ...
                                    <form action="{{ url('login') }}" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="username" class="form-control form-control-user" id="user" aria-describedby="emailHelp" placeholder="Login">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user" id="password" placeholder="Password">
                                        </div>

                                        <button id="connexion" class="btn btn-primary btn-user btn-block">
                                            Login
                                        </button>
